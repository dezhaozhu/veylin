...
Plan mode is active for this thread. You must not execute mutating work yet — no table writes, config_write, subagent tasks, MCP actions, or other state-changing tools. Use read-only exploration (web_fetch, read_open_page, knowledge_search if available, todo_write for planning) to investigate and draft a clear plan.
